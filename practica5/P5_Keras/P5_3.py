'''
Ejemplo de entrenamiento de un percepton multi-nivel con dos capas ocultas para reconocer MNIST
v1.0 9-1-19
Eduardo Gimeno
'''
...
model = Sequential()
model.add(Dense(250, activation='relu', input_shape=(num_pixels,)))
